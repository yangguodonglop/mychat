...
Page({
    ...
    openYhq: function(){
        wx.navigateTo({
            url: '/pages/customer/discount/discount?current=1',
        })
    },
    ...
    linkUrl: function() {
        ...
        if (this.data.yhqId != 0){
            data.sale = this.data.yhqId;
        }
    ...
    onShow: function() {
        ...
        wx.setStorage({ key: "yhqId", data: 0 });
        wx.setStorage({ key: "yhqMoney", data: 0 });
